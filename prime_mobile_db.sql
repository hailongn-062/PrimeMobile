...
-- Filtered Index xử lý linh hoạt cho phép nhiều giá trị NULL
...
-- =====================================================
-- 7. KHUYẾN MÃI (LOGIC MỚI)
-- =====================================================
INSERT INTO chuong_trinh_khuyen_mai (ten_ctkm, loai, gia_tri_uu_dai, don_hang_toi_thieu, ngay_bat_dau, ngay_ket_thuc, trang_thai) VALUES
(N'Siêu Sale Sinh Nhật', 'theo_don_hang', 5.00, 15000000, '2024-01-01', '2026-12-31', 'dang_dien_ra'),
(N'Giảm giá Tân Sinh Viên', 'theo_san_pham', 10.00, NULL, '2024-01-01', '2026-12-31', 'dang_dien_ra');
GO

-- Cấu hình phạm vi áp dụng cho mã theo sản phẩm
INSERT INTO pham_vi_khuyen_mai (ctkm_id, san_pham_id) VALUES
(2, 1), -- Áp dụng giảm tân sinh viên cho iPhone 15 Pro Max
(2, 2); -- Áp dụng giảm tân sinh viên cho iPhone 14
GO
...
-- 9. ĐƠN HÀNG & CHI TIẾT
-- =====================================================
-- Đơn hàng 1: ĐÃ HOÀN THÀNH - Đã thanh toán qua VNPay thành công
...
('DH1', 1, 2, 'online', 1, N'Nguyễn Văn An', '0912345678', N'Số 1, Ngõ 2', N'Phường Dịch Vọng', N'Quận Cầu Giấy', N'Hà Nội', 28990000, 500000, 30000, 1, '2026-06-25', 'da_hoan_thanh', 'da_thanh_toan', '2026-05-10');
...
-- =====================================================
-- 12. ĐÁNH GIÁ, TRUNG TÂM BẢO HÀNH & WISHLIST
-- =====================================================
