...
public interface IMayDienThoaiService {
     ...
     * <p>
     * Công thức: {@code soLuong(ton_kho)} −
     * {@code COUNT(may_dien_thoai có tinhTrang = 'trong_kho') của SKU đó}.
     * <p>
     ...
     * @throws jakarta.persistence.EntityNotFoundException nếu không tìm thấy bản
     *                                                     ghi tồn kho.
     */
     ...
     *                                                     bị trùng lặp.
     * @throws jakarta.persistence.EntityNotFoundException Nếu biến thể SKU hoặc kho không tồn tại.
     */
    void nhapDanhSachImei(Integer khoId, Integer bienTheSanPhamId, List<ThemImeiRequest> danhSachImei);

    /**
     * Lấy danh sách IMEI của một biến thể sản phẩm theo trạng thái cụ thể.
     * <p>
     * Phương thức này được sử dụng chủ yếu cho màn hình POS (Bán hàng tại quầy)
     * để hiển thị danh sách IMEI có sẵn (trạng thái 'trong_kho') cho nhân viên
     * chọn thay vì phải nhập tay.
     *
