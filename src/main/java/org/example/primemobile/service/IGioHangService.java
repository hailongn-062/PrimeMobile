 ...
 * <ul>
 *   <li><b>Khách đã đăng nhập:</b> truyền {@code khachHangId}, bỏ qua {@code sessionId}.</li>
 *   <li><b>Khách vãng lai:</b> truyền {@code sessionId} (UUID từ cookie/browser), bỏ qua {@code khachHangId}.</li>
 * </ul>
 * <p>
 * <b>Ràng buộc kho hàng bắt buộc:</b>
 * Mọi thao tác thêm/cập nhật số lượng đều phải kiểm tra tồn kho tại {@code kho_online}
 * (kho có {@code loai = 'kho_online'}). Nếu số lượng yêu cầu vượt quá tồn kho, ném
...
public interface IGioHangService {
     ...
     * @return {@link GioHang} kèm {@link org.example.primemobile.entity.ChiTietGioHang},
     ...
     *       ≤ tồn kho {@code kho_online}. Nếu vi phạm → {@link IllegalArgumentException}.</li>
     * </ol>
     *
     ...
     * @throws IllegalArgumentException nếu soLuong > tồn kho kho_online hoặc soLuong <= 0.
     * @throws jakarta.persistence.EntityNotFoundException nếu biến thể không tồn tại.
     */
     ...
     * @throws IllegalArgumentException nếu soLuongMoi > tồn kho kho_online hoặc soLuongMoi <= 0.
     * @throws jakarta.persistence.EntityNotFoundException nếu chiTietGioHangId không tồn tại.
     */
