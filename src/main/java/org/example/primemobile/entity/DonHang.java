 ...
 * Điều này đảm bảo đơn hàng không bị ảnh hưởng dù khách sau đó thay đổi địa
 * chỉ.
 * <p>
 * ✅ Toàn bộ FK đã được refactor hoàn tất — không còn thuộc tính Integer tạm
 * nào.
 * <p>
 ...
 * "chua_thanh_toan" | "dang_chuyen_huong" | "da_thanh_toan" | "that_bai"
 * <p>
 * Luật hủy đơn (system_rules.md §2.2):
 * Khách hàng chỉ được hủy khi trang_thai = 'cho_xac_nhan'.
 * Nút Hủy phải bị Disable khi đơn đã chuyển sang 'da_xac_nhan' hoặc
 * 'dang_giao'.
 * <p>
 * Quan hệ:
...
public class DonHang {
         ...
         * để Hibernate không cố ghi vào cột này gây lỗi "Cannot update a computed
         * column".
         */
         ...
         * Giá trị hợp lệ: "cho_xac_nhan" | "da_xac_nhan" | "dang_giao" | "da_giao" |
         * "da_huy"
         ...
         * Giá trị hợp lệ:
         * "chua_thanh_toan" — mới tạo đơn, chưa bắt đầu thanh toán
         * "dang_chuyen_huong" — đang redirect sang trang VNPay
         * "da_thanh_toan" — VNPay IPN xác nhận OK
         * "that_bai" — quá hạn hoặc VNPay trả lỗi
         */
        ...
        /**
         * Thời điểm hết hạn chờ thanh toán VNPay (thường sau 15 phút).
         * NULL với thanh toán offline (tiền mặt / chuyển khoản).
         */
